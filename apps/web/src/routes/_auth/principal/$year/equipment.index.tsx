...
/**
 * The Principal's own equipment, in the Principal's own workspace. The
 ...
 * row before this page can show anything.** The seeded `principal` account
 * deliberately has no `staff` row (`packages/auth/src/admin.ts`,
 * `ensureBootstrapAccount`), so out of the box this page renders its existing
 * "Your account has no staff record" state, which is correct.
 *
